	...
	while (line[char_counter] != 0) { // Loop until no more g-code words in line.
		...
		case 'M':
			...
			case 3: case 5:
				...
				switch (int_value) {
				case 3: gc_block.modal.spindle = LASER_POWER_ENABLE; break;
#ifndef USE_SPINDLE_DIR_AS_ENABLE_PIN
				case 4: gc_block.modal.spindle = LASER_POWER_ENABLE; break;
#endif
				case 5: gc_block.modal.spindle = LASER_POWER_DISABLE; break;
				}
				break;
#ifdef ENABLE_M7  
			case 7:
			...
			case 8: case 9:
				...
				switch (int_value) {
#ifdef ENABLE_M7
				case 7: gc_block.modal.coolant = LASER_ENABLE; break;
#endif
				case 8:
	...
	*/
	...
	if (gc_state.modal.program_flow) {
		...
		if (gc_state.modal.program_flow == PROGRAM_FLOW_PAUSED) {
			...
			gc_state.modal.spindle = LASER_POWER_DISABLE;
			gc_state.modal.coolant = LASER_DISABLE;

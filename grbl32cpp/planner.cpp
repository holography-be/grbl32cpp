...
uint8_t Cplanner::next_block_index(uint8_t block_index)
{
	block_index++;
...
plan_block_t *Cplanner::get_current_block()
{
...
uint8_t Cplanner::check_full_buffer()
{
...
void Cplanner::buffer_line(float *target, float feed_rate, uint8_t invert_feed_rate, int32_t line_number)
#else
void Cplanner::buffer_line(float *target, float feed_rate, uint8_t invert_feed_rate)
#endif
{
...
uint8_t Cplanner::get_block_buffer_count()
{
